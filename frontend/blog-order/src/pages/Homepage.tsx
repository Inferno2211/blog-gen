        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          <div className="text-center">
            ...
            <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto">
              Choose between purchasing contextual backlinks in existing articles or 
              commissioning custom AI-generated articles for our premium domains.
            </p>
          </div>
        </div>
      </header>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="text-center">
              <div className="bg-blue-100 rounded-full p-3 w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                <svg className="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.101m-.758 4.899L12 12l1.414-1.414L16.828 14" />
                </svg>
              </div>
              ...
              <p className="text-gray-600 mb-4">
                Get contextual backlinks integrated into our existing high-quality articles.
              </p>
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
                <span className="text-lg font-semibold text-blue-900">$15 per backlink</span>
              </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-4">
                Commission AI-generated articles on our premium domains with your specifications.
              </p>
              <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-4">
                <span className="text-lg font-semibold text-green-900">$25 per article</span>
              </div>
              <button
